                    ...
                    <form id="Form1" runat="server">
                        ...
                        <fieldset class="clearfix">
                            <div style="margin-left:200px">
                                ...
                                <asp:DropDownList ID="ddlfiltro" runat="server" Width="375px" Height="40px" OnSelectedIndexChanged="ddlfiltro_SelectedIndexChanged">
                                ...
                                <asp:Button class="boton" ID="btnSesion" runat="server" Width="300px" Text="Ir a Calendario" OnClick="btnSesion_Click" ></asp:Button></span>
                            </div>
                        </fieldset>
                        <div class="clearfix">
                        </div>
