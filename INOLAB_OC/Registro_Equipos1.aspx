<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro_Equipos1.aspx.cs" Inherits="INOLAB_OC.Registro_Equipos1" %>
...
<body>
      <form id="form1" runat="server">
        ...
        <div class="wrapper">
        <div class="logo" style="height: 80px"><img src="Imagenes/LOGO_Blanco_Lineas.png" class="logo"/></div>
            ...
            <nav>                  
                ...
                -->
                <asp:Button ID="btnOC_Servicio" runat="server" Text="Registros OC Servicio" class="boton"  Visible="true" OnClick="Button2_Click" UseSubmitBehavior="False"/>
    ...
    <section class="contenido2">
            <div class="etiqueta">
                <asp:Label ID="lblcontador" runat="server" Font-Size="14pt" Text="Registros OC - Equipos" Font-Bold="True" ></asp:Label>
    ...
    <section class="contenido wrapper">
        <table class="auto-style2">
         ...
         <asp:Button ID="btnvautorizar" runat="server"  Text="Autorizar Seleccionados" class="otroboton" OnClick="btnvautorizar_Click" UseSubmitBehavior="False" />
                ...
                <td class="auto-style5">&nbsp;<strong> Filtros de Búsqueda:</strong> <asp:DropDownList ID="cmbFiltro" runat="server" class="mercado" OnSelectedIndexChanged="cmbFiltro_SelectedIndexChanged" AutoPostBack="True" style="height: 20px">
...
<%--                        <div style="width:100%;">
            ...
            <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" Width="100%" Font-Size="9pt"  DataKeyNames="IdOC_E" CellPadding="4"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" ForeColor="#333333" GridLines="None" BorderStyle="Ridge" Font-Bold="False" CssClass="auto-style7">
                    <AlternatingRowStyle BackColor="White" />
            <Columns>
                
                <asp:TemplateField HeaderText="Admon" ItemStyle-Width="5%" >
                     <ItemTemplate>
                        <asp:CheckBox ID="CheckBox1" runat="server"  Enabled="False" Checked='<%# Convert.ToBoolean(Eval("Admon_V")) %>' Font-Bold="True" />
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Comercial" ItemStyle-Width="5%">
                    <ItemTemplate>
                        <asp:CheckBox ID="CheckBox3" runat="server" Enabled="False" Checked='<%# Convert.ToBoolean(Eval("Comercial")) %>'/>
                    </ItemTemplate>
               ...
               <%-- <asp:HyperLinkField DataNavigateUrlFields="IdOC_E" DataNavigateUrlFormatString="~/Detalles Registro.aspx?valor={0}" DataTextField="IdOC_E" HeaderText="ID" Target="_blank" >
                
                <ItemStyle Width="6%" HorizontalAlign="Center" Font-Bold="True"  />
                </asp:HyperLinkField>--%>
                
                <asp:BoundField DataField="IdOC_E"  ItemStyle-Width="4%" HeaderText="No." InsertVisible="False" ReadOnly="True" SortExpression="IdOC_E" Visible="True" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:HyperLinkField DataNavigateUrlFields="IdOC_E" DataNavigateUrlFormatString="~/Detalles Registro Equipo1.aspx?valor={0}" ItemStyle-Width="19%" DataTextField="Cliente" HeaderText="Cliente" SortExpression="Cliente" Target="_blank" >                
...
<ItemStyle  HorizontalAlign="Justify"></ItemStyle>
                ...
                <asp:BoundField DataField="Asesor"  HeaderText="Usuario" SortExpression="Usuario" ItemStyle-Width="7%" Visible="True">
<ItemStyle  HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:BoundField>
...
<ItemStyle Width="4%"></ItemStyle>
        ...
        <asp:SqlDataSource ID="DSBrowser" runat="server" ConnectionString="<%$ ConnectionStrings:BrowserCS %>" SelectCommand="SELECT * FROM [EquipoOC]"></asp:SqlDataSource>
            </div>
        <%-- </div>--%>
    </section>
