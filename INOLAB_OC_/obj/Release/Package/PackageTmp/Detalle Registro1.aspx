<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detalle Registro1.aspx.cs" Inherits="INOLAB_OC.Detalle_Registro1" %>
    ...
    <section class="contenido wrapper">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFecha_R" class="mercado" ReadOnly="True" DataFormatString="{0:d}" runat="server" Width="181px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">Servicio:</td>
                <td class="auto-style6">
                    <asp:TextBox ID="txtServicio" class="mercado" ReadOnly="True" runat="server"></asp:TextBox>
                    <asp:TextBox ID="txtTipoServicio" Class="mercado" ReadOnly="True" runat="server"></asp:TextBox>
                    <asp:TextBox ID="txtMeses" Class="mercado" ReadOnly="True" runat="server"></asp:TextBox>
                </td>
                <td class="auto-style7">Fecha OC Cliente:</td>
                <td class="auto-style8">
                    <asp:TextBox ID="txtFecha_OC" class="mercado" ReadOnly="True" runat="server" Width="181px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="adjunto1" runat="server" OnClick="LinkButton1_Click"  Font-Size="Small"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style11">Anexo 2:</td>
                <td class="auto-style12">
                    <asp:LinkButton ID="adjunto2" runat="server" OnClick="adjunto2_Click" Font-Size="Small"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="adjunto3" runat="server" OnClick="adjunto3_Click" Font-Size="Small"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="adjunto4" runat="server" OnClick="adjunto4_Click" Font-Size="Small"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="adjunto5" runat="server" OnClick="adjunto5_Click" Font-Size="Small"></asp:LinkButton>
                    <asp:Label ID="lblID" runat="server" Text="Label" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">Nota:
                    </td>
            ...
            <tr>
                <td class="auto-style2">Fecha del Registro:  <td class="auto-style3">
                    <asp:TextBox ID="txtFecha_Creacion" class="mercado" ReadOnly="True" runat="server" Width="169px"></asp:TextBox>
                </td>
